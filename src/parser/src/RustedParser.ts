...
export class RustedParser extends antlr.Parser {
    ...
    public static readonly ruleNames = [
        ...
        "if_statement", "while_statement", "expression", "assignment_expr", 
        "logical_expr", "comparison_expr", "additive_expr", "multiplicative_expr", 
        "unary_expr", "ref_primary_expr", "primary_expr", "function_call", 
        "type", "literal",
    ];
    ...
    public block(): BlockContext {
        ...
        try {
            ...
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 3422642820) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & 15) !== 0)) {
                {
                {
                this.state = 87;
                this.statement();
    ...
    public return_statement(): Return_statementContext {
        ...
        try {
            ...
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            if ((((_la) & ~0x1F) === 0 && ((1 << _la) & 3422552068) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & 15) !== 0)) {
                {
                this.state = 120;
                this.expression();
                }
    ...
    public static readonly _serializedATN: number[] = [
        4,1,38,248,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        6,2,7,7,7,2,8,7,8,2,9,7,9,2,10,7,10,2,11,7,11,2,12,7,12,2,13,7,13,
        2,14,7,14,2,15,7,15,2,16,7,16,2,17,7,17,2,18,7,18,2,19,7,19,2,20,
        7,20,2,21,7,21,2,22,7,22,2,23,7,23,1,0,5,0,50,8,0,10,0,12,0,53,9,
        0,1,0,1,0,1,1,1,1,3,1,59,8,1,1,2,1,2,1,2,1,2,3,2,65,8,2,1,2,1,2,
        1,2,1,2,1,2,1,3,1,3,1,3,5,3,75,8,3,10,3,12,3,78,9,3,1,3,3,3,81,8,
        3,1,4,1,4,1,4,1,4,1,5,1,5,5,5,89,8,5,10,5,12,5,92,9,5,1,5,1,5,1,
        6,1,6,1,6,1,6,1,6,1,6,3,6,102,8,6,1,7,1,7,3,7,106,8,7,1,7,1,7,1,
        7,1,7,1,7,3,7,113,8,7,1,7,1,7,1,8,1,8,1,8,1,9,1,9,3,9,122,8,9,1,
        9,1,9,1,10,1,10,1,10,1,10,1,10,1,10,3,10,132,8,10,3,10,134,8,10,
        1,11,1,11,1,11,1,11,1,12,1,12,1,13,1,13,1,13,3,13,145,8,13,1,14,
        1,14,1,14,5,14,150,8,14,10,14,12,14,153,9,14,1,15,1,15,1,15,5,15,
        158,8,15,10,15,12,15,161,9,15,1,16,1,16,1,16,5,16,166,8,16,10,16,
        12,16,169,9,16,1,17,1,17,1,17,5,17,174,8,17,10,17,12,17,177,9,17,
        1,18,1,18,1,18,3,18,182,8,18,1,19,1,19,1,19,3,19,187,8,19,1,19,1,
        19,1,19,3,19,192,8,19,1,20,1,20,1,20,1,20,1,20,1,20,1,20,3,20,201,
        8,20,1,21,1,21,1,21,1,21,1,21,5,21,208,8,21,10,21,12,21,211,9,21,
        3,21,213,8,21,1,21,1,21,1,22,1,22,1,22,3,22,220,8,22,1,22,1,22,1,
        22,1,22,1,22,1,22,1,22,1,22,1,22,1,22,1,22,1,22,5,22,234,8,22,10,
        ...
        32,162,1,0,0,0,34,170,1,0,0,0,36,181,1,0,0,0,38,191,1,0,0,0,40,200,
        1,0,0,0,42,202,1,0,0,0,44,243,1,0,0,0,46,245,1,0,0,0,48,50,3,2,1,
        ...
        1,0,0,0,119,121,5,13,0,0,120,122,3,24,12,0,121,120,1,0,0,0,121,122,
        1,0,0,0,122,123,1,0,0,0,123,124,5,12,0,0,124,19,1,0,0,0,125,126,
        5,14,0,0,126,127,3,24,12,0,127,133,3,10,5,0,128,131,5,15,0,0,129,
        132,3,20,10,0,130,132,3,10,5,0,131,129,1,0,0,0,131,130,1,0,0,0,132,
        134,1,0,0,0,133,128,1,0,0,0,133,134,1,0,0,0,134,21,1,0,0,0,135,136,
        5,16,0,0,136,137,3,24,12,0,137,138,3,10,5,0,138,23,1,0,0,0,139,140,
        3,26,13,0,140,25,1,0,0,0,141,144,3,28,14,0,142,143,5,11,0,0,143,
        145,3,26,13,0,144,142,1,0,0,0,144,145,1,0,0,0,145,27,1,0,0,0,146,
        151,3,30,15,0,147,148,7,0,0,0,148,150,3,30,15,0,149,147,1,0,0,0,
        150,153,1,0,0,0,151,149,1,0,0,0,151,152,1,0,0,0,152,29,1,0,0,0,153,
        151,1,0,0,0,154,159,3,32,16,0,155,156,7,1,0,0,156,158,3,32,16,0,
        157,155,1,0,0,0,158,161,1,0,0,0,159,157,1,0,0,0,159,160,1,0,0,0,
        160,31,1,0,0,0,161,159,1,0,0,0,162,167,3,34,17,0,163,164,7,2,0,0,
        164,166,3,34,17,0,165,163,1,0,0,0,166,169,1,0,0,0,167,165,1,0,0,
        0,167,168,1,0,0,0,168,33,1,0,0,0,169,167,1,0,0,0,170,175,3,36,18,
        0,171,172,7,3,0,0,172,174,3,36,18,0,173,171,1,0,0,0,174,177,1,0,
        0,0,175,173,1,0,0,0,175,176,1,0,0,0,176,35,1,0,0,0,177,175,1,0,0,
        0,178,179,7,4,0,0,179,182,3,36,18,0,180,182,3,38,19,0,181,178,1,
        0,0,0,181,180,1,0,0,0,182,37,1,0,0,0,183,192,3,40,20,0,184,186,5,
        ...
        5,5,0,0,232,234,3,44,22,0,233,231,1,0,0,0,234,237,1,0,0,0,235,233,
        1,0,0,0,235,236,1,0,0,0,236,239,1,0,0,0,237,235,1,0,0,0,238,230,
        1,0,0,0,238,239,1,0,0,0,239,240,1,0,0,0,240,241,5,3,0,0,241,242,
        5,4,0,0,242,244,3,44,22,0,243,216,1,0,0,0,243,217,1,0,0,0,243,222,
        1,0,0,0,243,226,1,0,0,0,243,228,1,0,0,0,244,45,1,0,0,0,245,246,7,
        5,0,0,246,47,1,0,0,0,27,51,58,64,76,80,90,101,105,112,121,131,133,
        144,151,159,167,175,181,186,191,200,209,212,219,235,238,243
    ];
