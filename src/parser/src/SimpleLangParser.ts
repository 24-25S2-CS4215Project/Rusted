...
export class SimpleLangParser extends antlr.Parser {
  ...
  public static readonly ruleNames = ["prog", "expression"];

  public get grammarFileName(): string {
    return "SimpleLang.g4";
  }
  public get literalNames(): (string | null)[] {
    return SimpleLangParser.literalNames;
  }
  public get symbolicNames(): (string | null)[] {
    return SimpleLangParser.symbolicNames;
  }
  public get ruleNames(): string[] {
    return SimpleLangParser.ruleNames;
  }
  public get serializedATN(): number[] {
    return SimpleLangParser._serializedATN;
  }
  ...
  public constructor(input: antlr.TokenStream) {
    ...
    this.interpreter = new antlr.ParserATNSimulator(
      this,
      SimpleLangParser._ATN,
      SimpleLangParser.decisionsToDFA,
  ...
  public expression(_p?: number): ExpressionContext {
    ...
    this.enterRecursionRule(
      localContext,
      2,
      SimpleLangParser.RULE_expression,
      _p
    );
    let _la: number;
    try {
  ...
  public static readonly _serializedATN: number[] = [
    ...
    8, 1, 10, 1, 12, 1, 25, 9, 1, 1, 1, 0, 1, 2, 2, 0, 2, 0, 2, 1, 0, 1, 2, 1,
    0, 3, 4, 27, 0, 4, 1, 0, 0, 0, 2, 13, 1, 0, 0, 0, 4, 5, 3, 2, 1, 0, 5, 6, 5,
    0, 0, 1, 6, 1, 1, 0, 0, 0, 7, 8, 6, 1, -1, 0, 8, 14, 5, 7, 0, 0, 9, 10, 5,
    5, 0, 0, 10, 11, 3, 2, 1, 0, 11, 12, 5, 6, 0, 0, 12, 14, 1, 0, 0, 0, 13, 7,
    1, 0, 0, 0, 13, 9, 1, 0, 0, 0, 14, 23, 1, 0, 0, 0, 15, 16, 10, 4, 0, 0, 16,
  ...
  public static get _ATN(): antlr.ATN {
    if (!SimpleLangParser.__ATN) {
      SimpleLangParser.__ATN = new antlr.ATNDeserializer().deserialize(
        SimpleLangParser._serializedATN
      );
    }
  ...
  private static readonly vocabulary = new antlr.Vocabulary(
    SimpleLangParser.literalNames,
    SimpleLangParser.symbolicNames,
    []
  );
  ...
  private static readonly decisionsToDFA =
    SimpleLangParser._ATN.decisionToState.map(
...
export class ProgContext extends antlr.ParserRuleContext {
  ...
  public override accept<Result>(
    visitor: SimpleLangVisitor<Result>
  ): Result | null {
